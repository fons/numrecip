 ...
 * Copyright (c) 2014.
 *
 * This file ChebeyshevApproximation3.scala is part of numrecip (numrecip)
 *
 *     numrecip / ChebeyshevApproximation3.scala is free software: you can redistribute it and/or modify
 *     it under the terms of the GNU General Public License as published by
 *     the Free Software Foundation, either version 3 of the License, or
 *     (at your option) any later version.
 *
 *     numrecip / ChebeyshevApproximation3.scala is distributed in the hope that it will be useful,
 ...
 */
object ChebeyshevApproximation3 {
  def run {
    ...
    val approx: ApproximationT = new Approximation(maxIter = 10, initialOrder = 20) with BarycentricInterpolation with HeuristicSolver
