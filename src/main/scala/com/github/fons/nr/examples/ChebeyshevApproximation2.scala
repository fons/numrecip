 ...
 * Copyright (c) 2014.
 *
 * This file ChebyshevApproximation2.scala is part of numrecip (numrecip)
 *
 *     numrecip / ChebyshevApproximation2.scala is free software: you can redistribute it and/or modify
 *     it under the terms of the GNU General Public License as published by
 *     the Free Software Foundation, either version 3 of the License, or
 *     (at your option) any later version.
 *
 *     numrecip / ChebyshevApproximation2.scala is distributed in the hope that it will be useful,
...
object ChebeyshevApproximation2 {
  ...
  def run {
     ...
     */
    println("approximation using chebeyshev polynomials on -1,1")
